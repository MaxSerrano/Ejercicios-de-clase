...
void display(void) //Más utilizada
{ 
	 ...
	 glutSolidTeapot(1.0); //Radio de la tetera
	 //glutWireCube(2.0f);
...
void keyboard(unsigned char key, int x, int y) //interacion con teclado
{
	 switch (key) 
	 {
		case 27: exit(0);
...
{ 
	 ...
	 glutCreateWindow ("Practica 1"); //name 

	 // Inicializamos el sistema, manda a llamar al sistema
	 init();
